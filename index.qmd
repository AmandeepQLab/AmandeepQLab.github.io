...
*This section will highlight the flagship projects that define my current research program.*

- **NV Control Framework** — Modular Python framework for controlling diamond NV center experiments.
- **Microwave-Free Quantum Magnetic Imaging** — Next-generation magnetic imaging using high-density NV ensembles.
- **Event Camera Quantum Imaging** — High-speed quantum imaging using neuromorphic event-based vision sensors.
- **Quantum Machines OPX Control** — Real-time quantum experiment control and pulse sequence development.

[Explore All Projects →](pages/projects.qmd)
